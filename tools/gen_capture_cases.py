...
def load_graph(folder):
    ...
    # A task_dummy has a logical ID but no physical execution records. Contract
    # it just like a tensor creator; otherwise ids[dummy] is empty and all of
    # its incoming waits silently disappear from the generated header.
    executed = {
